<?php include(dirname(__DIR__).'/views/templates/inbox_header.php'); ?>
    ...
    <aside class="sm-side">
        <div class="user-head">
            ...
            <div class="user-name">
                ...
                <span><a href="#"><?php echo($userEmail) ?></a></span>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url(); ?>Home/SendMsg" role="form" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" placeholder="" id="inputPassword1" class="form-control" name="Title">
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <div class="inbox-body text-center">
            ...
            <div class="btn-group">
                <a class="btn mini btn-info" href="<?php echo base_url(); ?>Account/Logout">
                    <i class="fa fa-cog"></i>
                </a>
            </div>
        </div>
              ...
              <tbody>
                <?php foreach ($allMessages as $item): ?>
                  <tr class="unread">
                      ...
                      <td class="view-message  dont-show"><?php echo $item['MessageTitle']; ?></td>
                      <td class="view-message "><?php echo $item['MessageContent']; ?></td>
                      <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                      <td class="view-message  text-right"><?php echo $item['MessageTime']; ?></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
